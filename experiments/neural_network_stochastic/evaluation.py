...
import torch
from experiments.neural_network_stochastic.data_generation import get_loss_of_algorithm, get_loss_of_neural_network, \
...
class EvaluationAssistant:
    ...
    def __init__(self,
                 ...
                 single_loss_of_algorithm: Callable,
        ...
        self.single_loss_of_algorithm = single_loss_of_algorithm
    ...
    def set_up_learned_algorithm(self) -> OptimizationAlgorithm:
        ...
        learned_algorithm = OptimizationAlgorithm(
            ...
            loss_function=StochasticParametricLossFunction(
                function=self.loss_of_algorithm,
                single_function=self.single_loss_of_algorithm,
...
def compute_losses_over_iterations_and_stopping_time(learned_algorithm: OptimizationAlgorithm,
    ...
    current_loss_function = StochasticParametricLossFunction(
        function=evaluation_assistant.loss_of_algorithm,
        single_function=evaluation_assistant.single_loss_of_algorithm,
        parameter=parameter)
...
def set_up_evaluation_assistant(loading_path: str) -> Tuple[EvaluationAssistant, NeuralNetworkForStandardTraining]:
    ...
    single_loss_of_algorithm = get_single_loss_of_algorithm(neural_network=neural_network_for_learning,
                                                            loss_of_neural_network=loss_of_neural_network)
    ...
    evaluation_assistant = EvaluationAssistant(
        ...
        single_loss_of_algorithm=single_loss_of_algorithm,
